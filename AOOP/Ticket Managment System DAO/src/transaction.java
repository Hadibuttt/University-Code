...
String URL="jdbc:mysql://localhost:3306/tms";
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
      try{
          ...
          tmsinfo t = new tmsinfo();
          t.id = Integer.parseInt(t1.getText());
          t.date = t21.getText()+"/"+t22.getText()+"/"+t23.getText();
          t.type = c1.getSelectedItem().toString();
          t.amount = Integer.parseInt(t4.getText());
          t.number = Integer.parseInt(t5.getText());
          t.served_by = c2.getSelectedItem().toString();
          
          tmsinfoDAO dao = new tmsinfoDAO();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        while(rs.next()){
               ...
               String[] date=rs.getString(2).split("/");
                    ...
                    t22.setText(date[1]);
                    t23.setText(date[2]);
                    c1.getModel().setSelectedItem(rs.getString(3));
                    t4.setText(rs.getString(4));
                    t5.setText(rs.getString(5));
                    c2.getModel().setSelectedItem(rs.getString(6));
